(function(){
	...
	app.controller('Experiment', ['$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
	  $scope.gridOptions = {  };
	  ...
	  $scope.gridOptions.columnDefs = [
	    ...
	    { name: 'name',enableCellEdit: true,  displayName: 'Name (editable)', width: '20%' },
	 ...
	 $scope.gridOptions.onRegisterApi = function(gridApi){
	  ...
	  $http.get('/exercise-services/webapi/sales/data')
